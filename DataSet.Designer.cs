...
namespace heladeria {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class ProductoDataTable : global::System.Data.TypedTableBase<ProductoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductoRow AddProductoRow(string Descripcion, double Precio, int Existencia, byte[] Foto, bool Activo, CategoriaRow parentCategoriaRowByCategoria_Producto, TipoRow parentTipoRowByTipo_Producto) {
    ...
    public partial class ProductoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Producto] WHERE (([id] = @Original_id) AND ([Precio] = @Origin" +
                ...
                "ctivo) AND ([CategoriaId] = @Original_CategoriaId) AND ([TipoId] = @Original_Tip" +
                "oId))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Producto] ([Descripcion], [Precio], [Existencia], [Foto], [Activo], [CategoriaId], [TipoId]) VALUES (@Descripcion, @Precio, @Existencia, @Foto, @Activo, @CategoriaId, @TipoId);
SELECT id, Descripcion, Precio, Existencia, Foto, Activo, CategoriaId, TipoId FROM Producto WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Producto] SET [Descripcion] = @Descripcion, [Precio] = @Precio, [Existencia] = @Existencia, [Foto] = @Foto, [Activo] = @Activo, [CategoriaId] = @CategoriaId, [TipoId] = @TipoId WHERE (([id] = @Original_id) AND ([Precio] = @Original_Precio) AND ([Existencia] = @Original_Existencia) AND ([Activo] = @Original_Activo) AND ([CategoriaId] = @Original_CategoriaId) AND ([TipoId] = @Original_TipoId));
SELECT id, Descripcion, Precio, Existencia, Foto, Activo, CategoriaId, TipoId FROM Producto WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Descripcion, Precio, Existencia, Foto, Activo, CategoriaId, TipoId FRO" +
                "M dbo.Producto";
        ...
        public virtual int Delete(int Original_id, double Original_Precio, int Original_Existencia, bool Original_Activo, int Original_CategoriaId, int Original_TipoId) {
        ...
        public virtual int Insert(string Descripcion, double Precio, int Existencia, byte[] Foto, bool Activo, int CategoriaId, int TipoId) {
            if ((Descripcion == null)) {
        ...
        public virtual int Update(string Descripcion, double Precio, int Existencia, byte[] Foto, bool Activo, int CategoriaId, int TipoId, int Original_id, double Original_Precio, int Original_Existencia, bool Original_Activo, int Original_CategoriaId, int Original_TipoId, int id) {
            if ((Descripcion == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Descripcion, double Precio, int Existencia, byte[] Foto, bool Activo, int CategoriaId, int TipoId, int Original_id, double Original_Precio, int Original_Existencia, bool Original_Activo, int Original_CategoriaId, int Original_TipoId) {
            return this.Update(Descripcion, Precio, Existencia, Foto, Activo, CategoriaId, TipoId, Original_id, Original_Precio, Original_Existencia, Original_Activo, Original_CategoriaId, Original_TipoId, Original_id);
        }
    }
